...
phacking <- function(systematic_phacking=T,initialN=10, hackrate=1, m1=0, m2=0, sd1=1, sd2=1, maxN=11, alpha=.05,bound=.1, alternative="two.sided", graph=TRUE, nSims=1000) {
...
InitialSigProb <- round(sum(outmat$Initial.p <= alpha) / nSims,3)
AvgHacks <- mean(outmat$Hackcount)
FinalSigProb <- round(sum(outmat$Final.p <= alpha) / nSims,3)
...
res1 <- phacking(systematic_phacking=T,initialN=5, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res2 <- phacking(systematic_phacking=T,initialN=10, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res3 <- phacking(systematic_phacking=T,initialN=15, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res4 <- phacking(systematic_phacking=T,initialN=20, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res5 <- phacking(systematic_phacking=T,initialN=25, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res6 <- phacking(systematic_phacking=T,initialN=30, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res7 <- phacking(systematic_phacking=T,initialN=35, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res8 <- phacking(systematic_phacking=T,initialN=40, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res9 <- phacking(systematic_phacking=T,initialN=45, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
res10 <- phacking(systematic_phacking=T,initialN=50, hackrate=1, m1=0, m2=1, sd1=2, sd2=2, maxN=64, alpha=.05,alternative="two.sided", graph=TRUE, nSims=30000)
